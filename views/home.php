    ...
    <body>
        ...
        <nav class="navbar navbar-<?= $_SESSION['KING']['myDesign'][0] ?> bg-primary fixed-bottom">
            <div class="container-fluid text-lowercase">
                <a class="navbar-brand" href="pages.php"><?= $_SESSION['KING']['theme']['football'] ?></a>
                <a class="navbar-brand" href="pages.php"><?= $_SESSION['KING']['theme']['tennis'] ?></a>
                <a class="navbar-brand" href="pages.php"><?= $_SESSION['KING']['theme']['basket_ball'] ?></a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header m-auto">
                                <p id="titleModal" class="modal-title text-dark" id="modalLabel">
                                    <?= $value->title ?></p>
                            </div>
                            ...
                            <div class="descModal modal-body text-center">
